...
$cfg['form_name'] = 'Kastner-pallavicino';
...
$cfg['adminnotification_subject'] = 'New message from Kastner-pallavicino Collection';

$cfg['adminnotification_hideemptyvalues'] = false;

$cfg['adminnotification_hideformurl'] = true;

$cfg['usernotification_inputid'] = 'cfgen-element-4-8';
...
$cfg['formvalidation_required'] = array('cfgen-element-4-6','cfgen-element-4-7','cfgen-element-4-8','cfgen-element-4-9');

$cfg['formvalidation_email'] = array('cfgen-element-4-8');
