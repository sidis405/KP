                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active" data-slide-number="1">
                                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/david-black01.jpg">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/david-black02.jpg">
                                        </div>
                                        <div class="item" data-slide-number="3">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/david-black03.jpg">
                                        </div>
                                        <div class="item" data-slide-number="4">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/david-black04.jpg">
                                        </div>
                    ...
                    <!-- thumb navigation carousel items -->
                      <ul class="list-inline">
                        <li> <a id="carousel-selector-0" class="selected">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/david-black01.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-1">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/david-black02.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-2">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/david-black03.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-3">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/david-black04.jpg" class="img-responsive">
                        </a></li>
                      </ul>                    
                </div>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel panel-default" id="panel1">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                          <div class="panel-body">
                           This bodysuite is made in lurex.             
                      ...
                      <div class="panel panel-default" id="panel3">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body">
                           Bordeaux • Blue • Mustard • Pink • Olive Green • White • Black • Light Green • Dark Pink
