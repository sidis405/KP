                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active" data-slide-number="1">
                                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/jack-blue01.jpg">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/jack-blue02.jpg">
                                        </div>
                                        <div class="item" data-slide-number="3">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/jack-blue03.jpg">
                                        </div>
                    ...
                    <!-- thumb navigation carousel items -->
                      <ul class="list-inline">
                        <li> <a id="carousel-selector-0" class="selected">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/thumb/jack-blue01.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-1">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/thumb/jack-blue02.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-2">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection17/thumb/jack-blue03.jpg" class="img-responsive">
                        </a></li>
                      </ul>                    
                </div>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                      ...
                      <div class="panel panel-default" id="panel3">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body">
                            Bi-color Blue, Shiny Brick, Champagne, Sand, Wine, Flowers
                          </div>
                        </div>
                      </div>
                    </div>
