                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active" data-slide-number="1">
                                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/athena01.jpg">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/athena02.jpg">
                                        </div>
                                        <div class="item" data-slide-number="3">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/athena03.jpg">
                                        </div>
                                        <div class="item" data-slide-number="4">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/athena04.jpg">
                                        </div>
                    ...
                    <!-- thumb navigation carousel items -->
                      <ul class="list-inline">
                        <li> <a id="carousel-selector-0" class="selected">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/athena01.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-1">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/athena02.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-2">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/athena03.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-3">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="img/collection/thumb/athena04.jpg" class="img-responsive">
                        </a></li>
                      </ul>                    
                </div>
