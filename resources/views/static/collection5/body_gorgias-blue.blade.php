                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active" data-slide-number="1">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/gorgiasblue01.jpg">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/gorgiasblue02.jpg">
                                        </div>
                    ...
                    <!-- thumb navigation carousel items -->
                      <ul class="list-inline">
                        <li> <a id="carousel-selector-0" class="selected">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/gorgiasblue01.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-1">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/gorgiasblue02.jpg" class="img-responsive">
                        </a></li>
                      </ul>                    
                </div>
