                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active" data-slide-number="1">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/alexander01.jpg">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/alexander02.jpg">
                                        </div>
                                        <div class="item" data-slide-number="3">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/alexander03.jpg">
                                        </div>
                                        <div class="item" data-slide-number="4">
                                            <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/alexander04.jpg">
                                        </div>
                    ...
                    <!-- thumb navigation carousel items -->
                      <ul class="list-inline">
                        <li> <a id="carousel-selector-0" class="selected">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/alexander01.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-1">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/alexander02.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-2">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/alexander03.jpg" class="img-responsive">
                        </a></li>
                        <li> <a id="carousel-selector-3">
                          <img alt="Body Suit all in ones Leotards body &amp; bodies" src="/img/collection5/thumb/alexander04.jpg" class="img-responsive">
                        </a></li>
                      </ul>                    
                </div>
                      ...
                      <div class="panel panel-default" id="panel1">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                          <div class="panel-body">
                           Material: Lycra and Tulle Swarovski
                          </div>
                        </div>
                      </div>
