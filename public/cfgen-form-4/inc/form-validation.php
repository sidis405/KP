...
if($_SESSION['captcha_img_string']['4275ef379d5ffe3057cc341d023f24c15a00f945'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-4-13'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-4-13-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-4-13']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}
